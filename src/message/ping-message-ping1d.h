...
namespace Ping1dId
{
    ...
    static const uint16_t SET_OSS_PROFILE_CONFIGURATION = 1007;
    ...
    static const uint16_t OSS_PROFILE_CONFIGURATION = 1301;
...
public:
    ...
    ping1d_set_device_id(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_set_range(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(18) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_set_speed_of_sound(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_set_mode_auto(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
public:
    ...
    ping1d_set_ping_interval(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_set_gain_setting(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
public:
    ...
    ping1d_set_ping_enable(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
class ping1d_set_oss_profile_configuration : public ping_message
{
public:
    ping1d_set_oss_profile_configuration(const ping_message& msg) : ping_message { msg } {}
    ping1d_set_oss_profile_configuration(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
        reinterpret_cast<uint16_t&>(msgData[4]) = 1007; // ID
        msgData[6] = 0;
        msgData[7] = 0;
    }
    ping1d_set_oss_profile_configuration(const uint8_t* buf, const uint16_t length) : ping_message { buf, length } {}
    ping1d_set_oss_profile_configuration() : ping_message { static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
    ...
    uint16_t number_of_points() const { return reinterpret_cast<uint16_t&>(msgData[headerLength + 0]); }
    void set_number_of_points(const uint16_t number_of_points) { reinterpret_cast<uint16_t&>(msgData[headerLength + 0]) = number_of_points; }
    uint8_t normalization_enabled() const { return reinterpret_cast<uint8_t&>(msgData[headerLength + 2]); }
    void set_normalization_enabled(const uint8_t normalization_enabled) { reinterpret_cast<uint8_t&>(msgData[headerLength + 2]) = normalization_enabled; }
    uint8_t enhance_enabled() const { return reinterpret_cast<uint8_t&>(msgData[headerLength + 3]); }
    void set_enhance_enabled(const uint8_t enhance_enabled) { reinterpret_cast<uint8_t&>(msgData[headerLength + 3]) = enhance_enabled; }

    int getMessageAsString(char* string, size_t size) const {
        int written = ping_message::getMessageAsString(string, size);
        if (written > 0 && written < static_cast<int>(size)) {
            return snprintf(string + written, size - static_cast<size_t>(written),
                "  number_of_points:  %" PRIu16 "\n"
                "  normalization_enabled:  %" PRIu8 "\n"
                "  enhance_enabled:  %" PRIu8 "\n"
                , number_of_points()
...
public:
    ...
    ping1d_firmware_version(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(16) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
    ...
    int getMessageAsString(char* string, size_t size) const {
        ...
        if (written > 0 && written < static_cast<int>(size)) {
            return snprintf(string + written, size - static_cast<size_t>(written),
                "  device_type:  %" PRIu8 "\n"
                "  device_model:  %" PRIu8 "\n"
                "  firmware_version_major:  %" PRIu16 "\n"
                "  firmware_version_minor:  %" PRIu16 "\n"
                , device_type()
                , device_model()
...
public:
    ...
    ping1d_device_id(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
public:
    ...
    ping1d_voltage_5(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_speed_of_sound(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
...
public:
    ...
    ping1d_range(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(18) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(8); // payload size
...
public:
    ...
    ping1d_mode_auto(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
public:
    ...
    ping1d_ping_interval(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_gain_setting(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
...
public:
    ...
    ping1d_transmit_duration(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_general_info(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(20) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_distance_simple(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(15) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_distance(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(34) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_processor_temperature(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_pcb_temperature(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_ping_enable(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(1); // payload size
...
class ping1d_oss_profile_configuration : public ping_message
{
public:
    ping1d_oss_profile_configuration(const ping_message& msg) : ping_message { msg } {}
    ping1d_oss_profile_configuration(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
        reinterpret_cast<uint16_t&>(msgData[4]) = 1301; // ID
        msgData[6] = 0;
        msgData[7] = 0;
    }
    ping1d_oss_profile_configuration(const uint8_t* buf, const uint16_t length) : ping_message { buf, length } {}
    ping1d_oss_profile_configuration() : ping_message { static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
...
public:
    ...
    ping1d_goto_bootloader(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(10) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping1d_continuous_start(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping1d_continuous_stop(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
