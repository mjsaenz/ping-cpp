...
public:
    ...
    bluebps_set_cell_voltage_minimum(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    bluebps_set_cell_voltage_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_set_current_max(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_set_current_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_set_temperature_max(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_set_temperature_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_set_stream_rate(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    bluebps_set_lpf_sample_frequency(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(14) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(4); // payload size
...
public:
    ...
    bluebps_set_lpf_setting(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_cell_voltage_min(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_cell_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_current_max(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_current_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_temperature_max(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_temperature_timeout(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    bluebps_state(uint8_t* buf,
uint8_t cell_voltages_length
) : ping_message { buf, static_cast<uint16_t>(20 + cell_voltages_length) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
    ...
    int getMessageAsString(char* string, size_t size) const {
        ...
        if (written > 0 && written < static_cast<int>(size)) {
            return snprintf(string + written, size - static_cast<size_t>(written),
                "  battery_voltage:  %" PRIu16 "\n"
                "  battery_current:  %" PRIu16 "\n"
                "  battery_temperature:  %" PRIu16 "\n"
                "  cpu_temperature:  %" PRIu16 "\n"
                "  flags:  %" PRIu8 "\n"
                , battery_voltage()
                , battery_current()
                , battery_temperature()
...
public:
    ...
    bluebps_events(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(16) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    bluebps_reboot(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(11) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    bluebps_erase_flash(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(10) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    bluebps_reset_defaults(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(10) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(0); // payload size
