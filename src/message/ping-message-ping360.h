...
public:
    ...
    ping360_set_device_id(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping360_device_data(uint8_t* buf,
uint16_t data_length
) : ping_message { buf, static_cast<uint16_t>(24 + data_length) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
    ...
    int getMessageAsString(char* string, size_t size) const {
        ...
        if (written > 0 && written < static_cast<int>(size)) {
            return snprintf(string + written, size - static_cast<size_t>(written),
                ...
                "  sample_period:  %" PRIu16 "\n"
                "  transmit_frequency:  %" PRIu16 "\n"
                "  number_of_samples:  %" PRIu16 "\n"
                , mode()
                , gain_setting()
                , angle()
                , transmit_duration()
...
public:
    ...
    ping360_auto_device_data(uint8_t* buf,
uint16_t data_length
) : ping_message { buf, static_cast<uint16_t>(30 + data_length) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping360_reset(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(12) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
        reinterpret_cast<uint16_t&>(msgData[2]) = static_cast<uint16_t>(2); // payload size
...
public:
    ...
    ping360_transducer(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(24) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping360_auto_transmit(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(26) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
...
public:
    ...
    ping360_motor_off(uint8_t* buf) : ping_message { buf, static_cast<uint16_t>(10) }
    {
        msgData[0] = 'B';
        msgData[1] = 'R';
